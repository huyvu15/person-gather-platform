...
async function main() {
  ...
  // Tạo một user để liên kết với các note
  const user = await prisma.user.create({
    data: {
      email: 'huyv80313@gmail.com',
      password: 'hashed-password', // nên dùng bcrypt nếu thực tế
      name: 'Huy Vũ',
      avatar: null
    }
  })

  // Tạo dữ liệu note mẫu
  const notes = [
    {
      title: 'Ghi chú về chuyến du lịch Đà Nẵng',
      content: 'Chuyến du lịch đến Đà Nẵng thật tuyệt vời...',
      category: 'travel',
    ...
    },
    {
      ...
      content: 'Cần hoàn thành dự án A trước thứ 6...',
      category: 'work',
  ...
  for (const note of notes) {
    await prisma.note.create({
      data: {
        ...note,
        user: {
          connect: { id: user.id } // 👈 bắt buộc theo schema
        }
      }
    })
  }

  console.log('✅ Đã seed thành công!')
}
...
//         ...note,
//         user: {
//           connect: { id: user.id }  // 👈 Thêm dòng này
//         }
//       }
//     })
//   }
